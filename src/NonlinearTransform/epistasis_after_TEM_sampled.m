...
data_test.log_fitness = log(data_test.DoubleMutantFitness);
data_test.Mut1_expt_fitness = log(data_test.Mut1Fitness);
data_test.Mut2_expt_fitness = log(data_test.Mut2Fitness);
data_test.expt_epistasis = data_test.log_fitness - (data_test.Mut1_expt_fitness + data_test.Mut2_expt_fitness);
